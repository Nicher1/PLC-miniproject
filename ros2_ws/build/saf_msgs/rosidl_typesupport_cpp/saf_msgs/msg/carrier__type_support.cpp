...
static const _Carrier_type_support_symbol_names_t _Carrier_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, saf_msgs, msg, Carrier)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, saf_msgs, msg, Carrier)),
  }
};
...
{
  return &::saf_msgs::msg::rosidl_typesupport_cpp::Carrier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, saf_msgs, msg, Carrier)() {
  return get_message_type_support_handle<saf_msgs::msg::Carrier>();
}
